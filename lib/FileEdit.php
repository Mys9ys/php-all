...
class FileEdit
{
    ...
    protected function uploadFile($tmp_name, $dest)
    {
        if (move_uploaded_file($tmp_name, $dest)) return true;
    ...
    protected function checkFile($fileName, $ext, $fileLastName = '')
    {
        ...
        return $this->checkFile($fileName, $ext, '_' . hash('crc32', time() . mt_rand(1, 100)));
    }
